...
async function processVideoInteractionSessions() {
                ...
                if (pause_check) {
                    ...
                    if (duration_pause > 2 && duration_pause < 600) {
                        if (video_interaction_id in video_interaction_map) {
                            if (video_interaction_map[video_interaction_id].hasOwnProperty('times_pause')){
                                video_interaction_map[video_interaction_id]['times_pause'] = video_interaction_map[video_interaction_id]['times_pause'] + 1
                                video_interaction_map[video_interaction_id]['duration_pause'] = video_interaction_map[video_interaction_id]['duration_pause'] + duration_pause;
                            } else {
    ...
    for (let interaction_id in video_interaction_map) {
        ...
        video_interaction_map[video_interaction_id]['session_id'] = video_interaction_id
...
async function processQuizSessions() {
    ...
    if (quiz_session_record.length === 0) {
        ...
        console.log('Sending', quiz_session_record.length, ' values to storage at ' + new Date());
    }
}
...
module.exports = {processGeneralSessions, processVideoInteractionSessions, processAssessmentsSubmissions, processQuizSessions};